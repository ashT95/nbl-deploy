...
var aperture = function(_renderer, _x, _y, _size){
    ...
    this.tex_sprite = new THREE.TextureLoader().load( "fl_custom_particle_system/assets/sprite_additive.png" );
...
aperture.prototype.init_shader = function(){
    ...
    for(var i = 0; i < this.num_layers; i++){
        ...
        this.shdrs[i].uniforms.is_points = {value: false};
        ...
        this.shdrs_point[i].uniforms.is_points = {value: true};
...
aperture.prototype.init_scene = function(){
    var circle_geom = new THREE.CircleBufferGeometry(this.size, this.num_dots);
