...
const animations = require('../../local_modules/animations');
const transmit = require('../../local_modules/transmit')
...
const clickEvents = "click touch touchstart touchend mousedown";
...
function activateTopic(id) {
  ...
  // We could probably get away with only having this run once on init
  // but just in case content/layout were to ever change mid-run:
...
$('.close').bind(clickEvents, function() {
  deactivateAllTopics();
})
...
},{"../../local_modules/animations":2,"../../local_modules/transmit":3,"hammerjs":28,"jquery":33,"socket.io-client":38}],2:[function(require,module,exports){
const $ = require('jquery');
...
animations.chapterInit = function(chapterBar, visibleOnInit = false) {
  ...
  tl.set(intro, {webkitMaskImage: makeWipeMask('top center', 'bottom center')})
    .set(intro, {webkitMaskSize: '100% 300%'})
    .set(intro, {webkitMaskPosition: (visibleOnInit ? '0% 0%' : '0% 100%')})
...
animations.chapterReveal = function(chapterBar) {
  ...
  tl.set(chapterBar, {autoAlpha: 1})
    .set(intro, {webkitMaskImage: makeWipeMask('center top', 'center bottom')})
    .fromTo( // must be fromTo or else the frames get out of wack
      particleAnim,
      2,
      {backgroundPosition: '0px 0px'},
      {backgroundPosition: '-42780px 0px', ease: SteppedEase.config(62)},
      'particlestart'
    )
    .fromTo(intro, 3, {webkitMaskPosition: '0% 100%'}, {webkitMaskPosition:'0% 0%'}, 'particlestart+=.5')
...
},{"gsap":27,"jquery":33}],3:[function(require,module,exports){
...
},{"socket.io-client":38}],4:[function(require,module,exports){
...
},{"../transport":17,"component-inherit":12,"debug":13,"engine.io-parser":24,"parseqs":35,"xmlhttprequest-ssl":23,"yeast":48}],22:[function(require,module,exports){
(function (global){
/**
 * Module dependencies.
 */
...
},{"../transport":17,"component-inherit":12,"debug":13,"engine.io-parser":24,"parseqs":35,"ws":9,"yeast":48}],23:[function(require,module,exports){
(function (global){
...
},{"./keys":25,"./utf8":26,"after":4,"arraybuffer.slice":5,"base64-arraybuffer":7,"blob":8,"has-binary2":29}],25:[function(require,module,exports){
...
},{"./on":40,"./socket":41,"backo2":6,"component-bind":10,"component-emitter":11,"debug":13,"engine.io-client":15,"indexof":32,"socket.io-parser":44}],40:[function(require,module,exports){
...
},{"./on":40,"component-bind":10,"component-emitter":11,"debug":13,"parseqs":35,"socket.io-parser":44,"to-array":47}],42:[function(require,module,exports){
(function (global){
...
},{"./binary":43,"./is-buffer":45,"component-emitter":11,"debug":13,"has-binary2":29}],45:[function(require,module,exports){
(function (global){
