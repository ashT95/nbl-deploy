...
void main() {
    ...
    for(int i = 0; i < 4; i++){
        ...
        vec2 _f = _dir * .00001/(_dist * _dist) * aperture_sizes[i] * pow(aperture_size_magnifiers[i], 1.8);
        //vec2 _f = _dir * .000006/(_dist * _dist) * aperture_sizes[i] * pow(aperture_size_magnifiers[i], 2.);
